#define ana_clas12_cxx
// The class definition in ana_clas12.h has been generated automatically
...
//
// root> T->Process("ana_clas12.C")
// root> T->Process("ana_clas12.C","some options")
// root> T->Process("ana_clas12.C+")
//
...
void ana_clas12::Begin(TTree * /*tree*/)
{
   ...
   TString option = GetOption();
      outfile = new TFile("ana_datatest.root","RECREATE");
...
void ana_clas12::SlaveBegin(TTree * /*tree*/)
{
...
Bool_t ana_clas12::Process(Long64_t entry)
{
  ...
  RunNumber = (*RUN_Config_run);
  
  if(RunNumber >= 6420) Ebeam = 10.2;

  //  cout<<RunNumber<<" "<<Ebeam<<endl;
...
void ana_clas12::SlaveTerminate()
{
